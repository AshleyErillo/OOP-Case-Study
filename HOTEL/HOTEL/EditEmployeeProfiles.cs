...
namespace HOTEL
{
    public partial class EditEmployeeProfiles : Form
    {
        public EditEmployeeProfiles()
        {
            InitializeComponent();
        }
        ...
        private void EditEmployeeProfiles_Load(object sender, EventArgs e)
        {
        ...
        private void Supervisor_Label_Click(object sender, EventArgs e)
        {
        ...
        private void Hiredate_label_Click(object sender, EventArgs e)
        {
        ...
        private void Jobtitle_LAbel_Click(object sender, EventArgs e)
        {

        }

        private void EmploymentInfor_label_Click(object sender, EventArgs e)
        {
        ...
        private void Region_label_Click(object sender, EventArgs e)
        {
        ...
        private void ContactNumber_Label_Click(object sender, EventArgs e)
        {
        ...
        private void MaritalStatus_Label_Click(object sender, EventArgs e)
        {
        ...
        private void Suffix_label_Click(object sender, EventArgs e)
        {
        ...
        private void PersonalInformation_label_Click(object sender, EventArgs e)
        {
